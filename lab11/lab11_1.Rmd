...
homerange %>% 
  ...
  geom_histogram(color = "black", fill = "steelblue1", alpha = 0.5)+
  labs(x = "Log 10 Homrange",
       y = "Frequency",
       title = "Log 10 Homerange Frequency")+
...
homerange %>% 
  ggplot(aes(x = log10.hra))+
  geom_density(color = "black", fill = "steelblue1", alpha = 0.5)+
  labs(x = "Log 10 Homrange",
       y = "Frequency",
       title = "Log 10 Homerange Frequency")+
  theme(plot.title = element_text(hjust = 0.5))
...
homerange %>% 
  ggplot(aes(x = log10.hra))+
  geom_histogram(aes(y = ..density..), color = "black", fill = "steelblue1", alpha = 0.5)+
...
homerange %>% 
  mutate(range_category = case_when(log10.hra <= 3.653 ~ "very_small",
                                    ...
                                    log10.hra > 4.595 & log10.hra <= 4.709 ~ "medium",
...
homerange %>% 
  ...
  labs(x = "Class",
       y = "Log 10 Mass",
       title = "Small Animal Log 10 Mass by Taxonomic Class")+
  theme(plot.title = element_text(hjust = 0.5))
```
