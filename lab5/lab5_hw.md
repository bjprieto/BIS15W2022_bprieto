...
I would use the `select()` function to isolate those variables from the original data.
...
##   name      race      alignment
##   <chr>     <chr>     <chr>    
## 1 Sif       Asgardian good     
## 2 Thor      Asgardian good     
## 3 Thor Girl Asgardian good
```

8. Among the bad guys, who are the male humans over 200 inches in height?

They are Bane, Doctor Doom, Kingpin, Lizard, and Scorpion (coincidentally all bad guys).
...
There are more good guys that are bald, i.e. 37 bald good guys > 35 bad bad guys.
...
## 10 Red Hulk       213      630
## 11 Darkseid       267      817
## 12 Juggernaut     287      855
## 13 Sasquatch      305      900
## 14 Ymir           305.      NA
```
...
## # … with 1 more variable: weight <dbl>
```
We don't have 16 rows in #10 because some of the characters satisfy both conditions so even if some are in both filtered results, they are only displayed once with "|" function. This functions reminds me a lot of the statistical "or" used in my STA 100 class and the symbolic logic "^" used in my PHI 12 class, which probably are all related.

## Height to Weight Ratio
13. It's easy to be strong when you are heavy and tall, but who is heavy and short? Which superheros have the highest height to weight ratio?

The superheros with the highest height to weight ratio are (in order) Groot, Galactus, Fin Fang Foom, Longshot, Jack-Jack, and Rocket Raccoon.
...
97 heroes have this combination of superpowers.
...
```
Doctor Strange has dimensional awareness, flight, longevity, telepathy, energy blasts, teleportation, telekinesis, magic, dimensional travel, phasing, astral projection, summoning, force fields, hypnokinesis, intangibility, banish(?), time travel, illusions, time manipulation, and invisibility.
