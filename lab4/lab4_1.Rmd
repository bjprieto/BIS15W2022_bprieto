...
```{r}
mammals.2 <- rename(mammals,genus="Genus",wean_mass="wean mass",max_life="max. life",litter_size="litter size",litters_per_year="litters/year")
names(mammals.2)
```
...
```{r}
names(mammals.2)
mammals.4 <- select(mammals.2,contains("mass"))
mammals.4
```

8. Select all of the columns that are of class `character`.  
```{r}
mammals.5 <- select_if(mammals.2,is.character)
mammals.5
```
