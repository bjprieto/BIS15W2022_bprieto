...
These data are untidy because each observation is grouped by patient and the columns are observations of variables?
...
These data are not tidy because the columns represent observations, i.e. day.
